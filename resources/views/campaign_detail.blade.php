            ...
            <div class="wsus__offer_details_area">
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="wsus__offer_details_banner">
                                ...
                                <div class="wsus__offer_details_banner_text">
                                    ...
                                    <a href="{{ $bannerOne->link }}" class="shop_btn">
                                        <span>{{ __('user.shop now') }}</span></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-md-6">
                            <div class="wsus__offer_details_banner">
                                ...
                                <div class="wsus__offer_details_banner_text">
                                    ...
                                    <a href="{{ $bannerTwo->link }}"
                                        class="shop_btn"><span>{{ __('user.shop now') }}</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    @if ($campaignProducts->count() > 0)
                                    ...
                                    <div class="wsus__product_item wsus__before">
                                        ...
                                        <div class="wsus__product_details">
                                            ...
                                            @else
                                                ...
                                                @else
                                                    <p class="wsus__price">
                                                        {{ currency_icon() }}{{ sprintf('%.2f', $campaignProduct->product->offer_price + $variantPrice) }}
                                                        <del>{{ currency_icon() }}{{ sprintf('%.2f', $totalPrice) }}</del>
                                                    </p>
                                                @endif
                                            @endif
                        ...
                        @endforeach
                    @else
                        <h3 class="text-danger text-center mt-5">
                            {{ 'Currently no product available under this campaign!' }}</h3>
                    @endif
                </div>

                @foreach ($campaignProducts as $campaignProduct)
                    <section class="product_popup_modal">
                        <div class="modal fade" id="productModalView-{{ $campaignProduct->product->id }}" tabindex="-1"
                            aria-hidden="true">
                ...
                <form id="productModalFormId-{{ $campaignProduct->product->id }}">
                    <div class="wsus__quentity">
                        ...
                        <div class="modal_btn">
                            <button onclick="productModalDecrement('{{ $campaignProduct->product->id }}')" type="button"
                ...
                @if ($campaignProduct->product->sku)
                    <p class="brand_model"><span>{{ __('user.Model') }} :</span> {{ $campaignProduct->product->sku }}
                    </p>
                @endif
