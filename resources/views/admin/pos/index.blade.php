                            ...
                            <div class="col-lg-12 col-xl-8  product-bg">
                                                ...
                                                <div class="modal-from">
                                                    <form action="{{ route('admin.product.store') }}" method="POST"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-6">
                                                                <label>{{ __('admin.Short Name') }} <span
                                                                        class="text-danger">*</span></label>
                                                            ...
                                                            <div class="form-group col-6">
                                                                ...
                                                                <select name="child_category" class="form-control select2"
                                                                    id="child_category">
                                                                    <option value="">
                                                            ...
                                                            <div class="form-group col-12">
                                                                ...
                                                                <div>
                                                                    <input type="checkbox"name="top_product"
                                                                        id="top_product"> <label for="top_product"
                                                                        class="mr-3">{{ __('admin.Top Product') }}</label>

                                                                    <input type="checkbox" name="new_arrival"
                                                                        id="new_arrival"> <label for="new_arrival"
                                                                        class="mr-3">{{ __('admin.New Arrival') }}</label>

                                                                    <input type="checkbox" name="best_product"
                                                                        id="best_product"> <label for="best_product"
                                                                        class="mr-3">{{ __('admin.Best Product') }}</label>

                                                                    <input type="checkbox" name="is_featured"
                                                                        id="is_featured"> <label for="is_featured"
                                                                        class="mr-3">{{ __('admin.Featured Product') }}</label>
                                                                </div>
                                                            </div>

                                                            <div class="form-group col-12">
                                                                <label>{{ __('admin.Status') }} <span
                                                                        class="text-danger">*</span></label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <button type="submit"
                                                                    class="modal-from-btm-btn">{{ __('admin.Save') }}</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                ...
                                <div class="row row-p-30">
                                    @foreach ($products as $index => $product)
                                        ...
                                        <div class="modal fade" id="exampleModalLong{{ $product->id }}" role="dialog"
                                            aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 raindo-pd">
                                                                ...
                                                                <div class="availabillity">
                                                                    <h2>
                                                                        ...
                                                                        @if ($product->qty == 0)
                                                                            <span
                                                                                style="color: red;">{{ __('admin.Stock Out') }}</span>
                                                                        @else
                                                                            <span>{{ $product->qty }}
                                                                ...
                                                                <form
                                                                    action="{{ route('admin.pos.cart.order.detils', $product->id) }}"
                                                                    method="post">
                                                                    @csrf
                                                                        ...
                                                                        <div class="row">
                                                                            @foreach ($product->activeVariants as $variant)
                                                                                <div class="col-md-6">
                                                                                    ...
                                                                                    <select id="size"
                                                                                        name="selectedValues[{{ $variant->id }}]"
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="billing-btn-three">
                                                            ...
                                                            <!-- Modal -->
                                                            <div class="modal fade" id="exampleModalLong-1"
                                                                            ...
                                                                            <div class="modal-from">
                                                                                <form
                                                                                    ...
                                                                                    <div class="from-item-main">
                                                                                        <div class="modal-from-item-d-b">
                                                                                            <div class="modal-from-inner">
                                                                                                <label
                                                                                                    ...
                                                                                                    class="form-label">{{ __('admin.Full Name') }}
                                                                                                    <span
                                                                                        ...
                                                                                        <div
                                                                                            class="modal-from-item modal-from-item-two">
                                                                                            <div class="modal-from-inner">
                                                                                                <label
                                                                                                    for="exampleFormControlInput1"
                                                                                        ...
                                                                                        <div class="from-select-main">
                                                                                            <div
                                                                                                class="from-select-main-item">
                                                                                                <label
                                                                                                    for="exampleFormControlInput1"
                                                                                                    class="form-label">{{ __('admin.Country') }}
                                                                                                    <span
                                                                                                        style="color: red;">*</span></label>
                                                                                                <div
                                                                                                    class="from-select-main">
                                                                                                    <select
                                                                                        ...
                                                                                        <div
                                                                                            class="from-select-main-item-two">
                                                                                            <div class="from-select-main">
                                                                                                <div
                                                                                                    class="from-select-main-item">
                                                                                                    <label
                                                                                                        for="exampleFormControlInput1"
                                                                                                        class="form-label">{{ __('admin.State') }}
                                                                                                        <span
                                                                                                            style="color: red;">*</span></label>
                                                                                                    <div
                                                                                                        class="from-select-main">
                                                                                            ...
                                                                                            <div class="from-select-main">
                                                                                                <div
                                                                                                    ...
                                                                                                    <label
                                                                                                        for="exampleFormControlInput1"
                                                                                                        class="form-label">{{ __('admin.City') }}
                                                                                                        <span
                                                                                                            style="color: red;">*</span></label>
                                                                                                    <div
                                                                                                        class="from-select-main">
                                                                                        ...
                                                                                        <div class=" modal-from-item-d-b">
                                                                                            <div class="modal-from-inner">
                                                                                                <label
                                                                                                    for="exampleFormControlInput1"
                                                                                                    class="form-label">{{ __('admin.Address') }}
                                                                                                    <span
                                                                                                        style="color: red;">*</span></label>
                                                    ...
                                                    <div class="col-sm-6 d-flex justify-content-end">
                                                        <div class="form-group custom-form-group">
                                                            <form method="post"
                                                                action="{{ route('admin.pos.update.cart.order') }}">
                                                                @csrf
                                                                @method('PUT')
                                                ...
                                                <div class="delivery-information-top-item-two">
                                                    ...
                                                    <div class="count">
                                                        ...
                                                        <div class="count-text">
                                                            <input type="number" name="qty_update[{{ $product->id }}]"
                                                                value="{{ $product->qty }}">
                                                        </div>
                                                        <div class="plus">
                                                            <p>
                                                    ...
                                                    <div class="price">
                                                        @php
                                                            if ($product->card_product?->offer_price == '') {
                                                                ...
                                                                $total =
                                                                    $product->qty * $product->card_product->offer_price;
