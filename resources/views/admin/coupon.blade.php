...
@section('admin-content')
    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <a href="javascript:;" data-toggle="modal" data-target="#createCoupon" class="btn btn-primary"><i
                                        ...
                                        <tbody>
                                            @foreach ($coupons as $index => $coupon)
                                                <tr>
                                                    ...
                                                    <td>{{ $coupon->name }}</td>
                                                    <td>{{ $coupon->code }}</td>
                                                    <td>{{ $coupon->offer_type == 1 ? '' : currency_icon() }}{{ $coupon->discount }}{{ $coupon->offer_type == 1 ? '%' : '' }}
                                                    </td>
                                                    ...
                                                    <td>
                                                        @if ($coupon->status == 1)
                                                            <a href="javascript:;"
                                                                onclick="changeCouponStatus({{ $coupon->id }})">
    ...
    <!-- Modal -->
    <div class="modal fade" id="createCoupon" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        aria-hidden="true">
                        ...
                        <form action="{{ route('admin.coupon.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" id="expired_date" class="form-control datepicker"
                                        name="expired_date" autocomplete="off">
                                </div>
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <select name="offer_type" id="" class="form-control">
                                                ...
                                                <option value="2">{{ __('Amount') }}({{ currency_icon() }})
                                                </option>
                                            </select>
                                        </div>
                        ...
                        <div class="container-fluid">
                            <form action="{{ route('admin.coupon.update', $coupon->id) }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        <label>{{ __('Number of times') }} <span class="text-danger">*</span></label>
                                        <input type="number" id="number_of_time" class="form-control"
                                            name="number_of_time" value="{{ $coupon->max_quantity }}">
                                    </div>

                                    <div class="form-group col-12">
                                        <label>{{ __('Expired Date') }} <span class="text-danger">*</span></label>
                                        <input type="text" id="expired_date" class="form-control datepicker"
                                            value="{{ $coupon->expired_date }}" name="expired_date" autocomplete="off">
                                    </div>
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <select name="offer_type" id="" class="form-control">
                                                    <option {{ $coupon->offer_type == 1 ? 'selected' : '' }}
                                                        value="1">{{ __('Percentage') }}(%)</option>
                                                    <option {{ $coupon->offer_type == 2 ? 'selected' : '' }}
                                                        value="2">{{ __('Amount') }}({{ currency_icon() }})
                                                    </option>
                                                </select>
                                            </div>
                                            <input type="text" name="discount" class="form-control"
                                                placeholder="Discount" aria-label="Discount"
                                                aria-describedby="basic-addon1" value="{{ $coupon->discount }}">
                                        </div>
                                    </div>
