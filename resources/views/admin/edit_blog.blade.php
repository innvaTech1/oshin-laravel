    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <a href="{{ route('admin.blog.index') }}" class="btn btn-primary"><i class="fas fa-list"></i>
                    {{ __('Blog') }}</a>
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="card">
                                ...
                                <form action="{{ route('admin.blog.update', $blog->id) }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12">
                                            ...
                                            <div>
                                                <img id="preview-img" class="admin-img" src="{{ asset($blog->image) }}"
                                                    alt="">
                                            </div>
                                        </div>

                                        <div class="form-group col-12">
                                            <label>{{ __('New Thumbnail Image') }} <span
                                        ...
                                        <div class="form-group col-12">
                                            <label>{{ __('Banner Image Preview') }}</label>
                                            <div>
                                                <img id="preview-banner-img" class="admin-banner-img"
                                                    src="{{ asset($blog->banner_image) }}" alt="">
                                            </div>
                                        </div>

                                        <div class="form-group col-12">
                                            <label>{{ __('New Banner Image') }} <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group col-12">
                                            ...
                                            <select name="show_homepage" class="form-control">
                                                <option {{ $blog->show_homepage == 0 ? 'selected' : '' }} value="0">
                                                    {{ __('No') }}</option>
                                                <option {{ $blog->show_homepage == 1 ? 'selected' : '' }} value="1">
                                                    {{ __('Yes') }}</option>
                                            </select>
                                        </div>
