                                                            ...
                                                            <div class="card-body">
                                                                <form action="{{ route('admin.update-general-setting') }}"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="">{{ __('admin.User Registration/Login') }}
                                                                        </label>
                                                        ...
                                                        <div class="card m-0">
                                                            <div class="card-body">
                                                                <form action="{{ route('admin.update-theme-color') }}"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="">{{ __('admin.Theme Color One') }}</label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="">{{ __('admin.Theme Color Two') }}</label>
                                                                        <input type="color" class="form-control"
                                                                            name="theme_two"
                                                                ...
                                                                <form action="{{ route('admin.update-cookie-consent') }}"
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <label
                                                                                    for="bg_color">{{ __('admin.Background Color') }}</label>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <label
                                                                                    for="text_color">{{ __('admin.Text Color') }}</label>
                                                                                <input class="form-control" type="color"
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <label
                                                                                    for="border_color">{{ __('admin.Border Color') }}</label>
                                                                                <input class="form-control" type="color"
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <label
                                                                                    for="btn_bg_color">{{ __('admin.Button Color') }}</label>
                                                                                <input class="form-control" type="color"
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <label
                                                                                    for="btn_text_color">{{ __('admin.Button Text Color') }}</label>
                                                                                <input class="form-control" type="color"
                                                                                    name="btn_text_color"
                                                                                    id="btn_text_color"
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <label
                                                                                    for="">{{ __('admin.Button Text') }}</label>
                                                        ...
                                                        <div class="card m-0">
                                                            <div class="card-body">
                                                                <form action="{{ route('admin.update-tawk-chat') }}"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="">{{ __('admin.Tawk Chat Link') }}</label>
                                                                        <input type="text" class="form-control"
                                                                            name="chat_link"
                                                        ...
                                                        <div class="card m-0">
                                                            <div class="card-body">
                                                                <form action="{{ route('admin.update-social-login') }}"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="">{{ __('admin.Google Client Id') }}</label>
                                                                        <input type="text"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="">{{ __('admin.Google Secret Id') }}</label>
                                                                        <input type="text"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="">{{ __('admin.Google Redirect Url') }}</label>
                                                                        <input type="text"
