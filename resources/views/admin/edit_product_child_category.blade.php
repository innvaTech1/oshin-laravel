        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active"><a
                            href="{{ route('admin.product-sub-category.index') }}">{{ __('admin.Product Sub Category') }}</a>
                    </div>
            ...
            <div class="section-body">
                <a href="{{ route('admin.product-child-category.index') }}" class="btn btn-primary"><i
                        class="fas fa-list"></i> {{ __('admin.Product Child Category') }}</a>
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('admin.product-child-category.update', $childCategory->id) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-12">
                                            <label>{{ __('admin.Sub Category') }} <span
                                        ...
                                        <div class="form-group col-12">
                                            <label>{{ __('admin.Child Category Name') }} <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group col-12">
                                            ...
                                            <select name="city_id" class="form-control select2" id="city_id">
                                                ...
                                                @foreach ($cities as $city)
                                                    <option {{ $childCategory->city_id == $city->id ? 'selected' : '' }}
