                                                            ...
                                                            <div class="card-body">
                                                                <form action="{{ route('admin.update-aamarpay') }}"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="">{{ __('admin.Aamarpay Status') }}</label>
                                                                        <div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="">{{ __('admin.Signature Key') }}</label>
                                                                        <input type="text" class="form-control"
                                                                            name="signature_key"
                                                        ...
                                                        <div class="card m-0">
                                                            <div class="card-body">
                                                                <form action="{{ route('admin.update-bank') }}"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="">{{ __('admin.Bank Payment Status') }}</label>
                                                                        <div>
                                                                            @if ($bank->status == 1)
                                                                                <input id="status_toggle" type="checkbox"
                                                                                    checked data-toggle="toggle"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="">{{ __('admin.Account Information') }}</label>
                                                    ...
                                                    <div class="tab-pane fade" id="cashTab" role="tabpanel"
                                                        ...
                                                        <div class="card m-0">
                                                            <div class="card-body">
                                                                <div class="form-group">
                                                                    <label
                                                                        for="">{{ __('admin.Cash on delivery Status') }}</label>
                                                                    <div>
