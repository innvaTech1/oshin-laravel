                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-3">
                                    <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                        ...
                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="paymongo-tab" data-toggle="tab" href="#paymongoTab" role="tab" aria-controls="paymongoTab" aria-selected="true">{{__('admin.Paymongo')}}</a>
                                        </li>
                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-paymongo') }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            @method('PUT')
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Paymongo Status')}}</label>
                                                                <div>
