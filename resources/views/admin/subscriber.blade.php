...
@section('admin-content')
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="javascript:;" data-toggle="modal"
                                                            data-target="#sendEmailModal-{{ $subscriber->id }}"
                                                            class="btn btn-primary btn-sm"><i class="far fa-envelope"
                                                                aria-hidden="true"></i></a>

                                                        <a href="javascript:;" data-toggle="modal"
                                                            data-target="#deleteModal" class="btn btn-danger btn-sm"
                                                            onclick="deleteData({{ $subscriber->id }})"><i
    ...
    @foreach ($subscribers as $index => $subscriber)
        <!-- Modal -->
        <div class="modal fade" id="sendEmailModal-{{ $subscriber->id }}" tabindex="-1" role="dialog"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <form action="{{ route('admin.specification-subscriber-email', $subscriber->id) }}"
                                method="POST">
                                @csrf
                                <div class="form-group">
                                    <label for="">{{ __('Subject') }}</label>
