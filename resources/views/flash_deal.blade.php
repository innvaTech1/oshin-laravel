            ...
            <div class="wsus__offer_details_area">
                                ...
                                <div class="wsus__product_item">
                                    ...
                                    <ul class="wsus__single_pro_icon">
                                        <li><a data-bs-toggle="modal"
                                                data-bs-target="#productModalView-{{ $product->id }}"><i
                ...
                @foreach ($products as $product)
                    <section class="product_popup_modal">
                        <div class="modal fade" id="productModalView-{{ $product->id }}" tabindex="-1"
                            aria-hidden="true">
                ...
                <form id="productModalFormId-{{ $product->id }}">
                    <div class="wsus__quentity">
                        ...
                        <div class="modal_btn">
                            ...
                            <input id="productModalQty-{{ $product->id }}" name="quantity" readonly
