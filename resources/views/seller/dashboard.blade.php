                                ...
                                <div class="card-body">
                                    @php
                                        ...
                                        foreach ($todayOrders as $key => $todayOrder) {
                                            $orderProducts = $todayOrder->orderProducts->where(
                                                'seller_id',
                                                $seller->id,
                                            );
                                            foreach ($orderProducts as $key => $orderProduct) {
                                                $price =
                                                    $orderProduct->unit_price * $orderProduct->qty + $orderProduct->vat;
                                                $todayEarning = $todayEarning + $price;
                                                $todayProductSale = $todayProductSale + $orderProduct->qty;
                                            }
                                        }
                                    @endphp
                                    {{ currency_icon() }}{{ $todayEarning }}
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-statistic-1">
                            ...
                            <div class="card-wrap">
                                ...
                                <div class="card-body">
                                    ...
                                    {{ currency_icon() }}{{ $todayPendingEarning }}
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    @php
                                        ...
                                        foreach ($monthlyOrders as $key => $monthlyOrder) {
                                            $orderProducts = $monthlyOrder->orderProducts->where(
                                                'seller_id',
                                                $seller->id,
                                            );
                                            foreach ($orderProducts as $key => $orderProduct) {
                                    ...
                                    @endphp
                                    {{ currency_icon() }}{{ $thisMonthEarning }}
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    @php
                                        ...
                                        foreach ($yearlyOrders as $key => $yearlyOrder) {
                                            $orderProducts = $yearlyOrder->orderProducts->where(
                                                'seller_id',
                                                $seller->id,
                                            );
                                            foreach ($orderProducts as $key => $orderProduct) {
                                ...
                                <div class="card-body">
                                    @php
                                        ...
                                        foreach ($totalOrders as $key => $totalOrder) {
                                            $orderProducts = $totalOrder->orderProducts->where(
                                                'seller_id',
                                                $seller->id,
                                            );
                                            foreach ($orderProducts as $key => $orderProduct) {
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="card card-statistic-1">
                            ...
                            <div class="card-wrap">
                                ...
                                <div class="card-body">
                                    {{ currency_icon() }}{{ $totalPendingWithdraw }}
                                </div>
                            </div>
                        </div>
                    </div>
