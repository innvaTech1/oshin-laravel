    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <a href="{{ route('seller.product.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i>
                    {{ __('user.Add New') }}</a>
                <div class="row mt-4">
                    <div class="col">
                        <div class="card">
                                            ...
                                            @foreach ($products as $index => $product)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($product->status == 1)
                                                            <span
                                                                class="badge badge-success">{{ __('user.Active') }}</span>
                                                        @else
                                                            <span
                                                                class="badge badge-danger">{{ __('user.Inactive') }}</span>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        ...
                                                        <div class="dropdown d-inline">
                                                            ...
                                                            <div class="dropdown-menu" x-placement="top-start"
                                                                ...
                                                                <a class="dropdown-item has-icon"
                                                                    href="{{ route('seller.product-gallery', $product->id) }}"><i
                                                                        class="far fa-image"></i>
                                                                    {{ __('user.Image Gallery') }}</a>

                                                                <a class="dropdown-item has-icon"
                                                                    href="{{ route('seller.product-highlight', $product->id) }}"><i
                                                                        class="fas fa-lightbulb"></i>
                                                                    {{ __('user.Highlight') }}</a>

                                                                <a class="dropdown-item has-icon"
                                                                    href="{{ route('seller.product-variant', $product->id) }}"><i
                                                                        class="fas fa-cog"></i>
                                                                    {{ __('user.Product Variant') }}</a>
                                                            </div>
                                                        </div>
