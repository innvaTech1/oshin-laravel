              ...
              <div class="profile-widget-description">
                ...
                @method('PUT')
                    <div class="row">
                        ...
                        <div class="form-group col-12">
                            <label>{{__('user.New Banner Image')}}</label>
                            <input type="file" class="form-control-file" name="banner_image">
                        </div>


                        <div class="form-group col-12">
                            <label>{{__('user.Shop Name')}} <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group col-12">
                            <label>{{__('user.Greeting Message for Chatbox')}} <span class="text-danger">*</span></label>
                            <textarea name="greeting_msg" id="greeting_msg" class="form-control text-area-5" cols="30" rows="10">{{ $seller->greeting_msg }}</textarea>
                        </div>

                        <div class="form-group col-12">
                            <label>{{__('user.Description')}} <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button class="btn btn-primary">{{__('user.Save Changes')}}</button>
                        </div>
                    </div>
                    </div>
                </form>
