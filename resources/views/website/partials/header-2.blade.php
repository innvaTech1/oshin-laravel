<header>
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-2 col-7 col-md-8 col-lg-2 d-none d-md-block">
                                    ...
                                    <li><a class="wsus__droap_arrow"
                                        ...
                                        <ul class="wsus_menu_cat_droapdown">
                                            @foreach ($productCategory->subCategories as $subCategory)
                                                ...
                                                @else
                                                    <li><a
                                                            href="{{ route('product', ['sub_category' => $subCategory->slug]) }}">{{ $subCategory->name }}
            ...
            <div class="col-xl-4 col-3 col-md-3 col-lg-4 d-none d-md-block">
