                                                        ...
                                                        <form id="reportModalForm">
                                                            ...
                                                            <div class="wsus__single_input">
                                                                ...
                                                                <input type="text" name="subject"
                                                                    placeholder="{{ __('user.Type Subject') }}">
                                                            ...
                                                            <div class="wsus__single_input">
                                                                ...
                                                                <textarea name="description" cols="3" rows="3" placeholder="{{ __('user.Description') }}"></textarea>
                                                            </div>
                        ...
                        <ul class="nav nav-pills mb-3" id="pills-tab3" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="pills-home-tab7" data-bs-toggle="pill"
                                    ...
                                    aria-controls="pills-home" aria-selected="true">{{ __('user.Description') }}</button>
                            </li>
                            @if ($product->is_specification == 1)
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-profile-tab7" data-bs-toggle="pill"
                                        ...
                                        aria-selected="false">{{ __('user.Specification') }}</button>
                                </li>
                            @endif
                                    ...
                                    <div class="col-xl-6 col-lg-6 mb-4 mb-lg-0">
                                        <div class="wsus__pro_det_info">
                                            ...
                                            @foreach ($product->specifications as $specification)
                                                <p><span>{{ $specification->key->key }}</span>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-xxl-7 col-md-6 mt-4 mt-md-0">
                                                <div class="wsus__pro_det_vendor_text">
                                                    ...
                                                    <p><span>{{ __('user.Store Name') }}:</span>
                                                        {{ $user->seller->shop_name }}</p>
                                                    <p><span>{{ __('user.Address') }}:</span> {{ $user->address }}
                                        ...
                                        <div class="row">
                                            <div class="col-xl-8 col-lg-7">
                                                <div class="wsus__comment_area">
                                                    <h4>{{ __('user.Reviews') }}
                                                        <span>{{ $totalProductReviewQty }}</span>
                                                    </h4>
                                                    @foreach ($productReviews as $review)
                                                        <div class="wsus__main_comment">
                                                            <div class="wsus__comment_img">
                                                                <img src="{{ $review->user->image ? asset($review->user->image) : asset($defaultProfile->image) }}"
                                                ...
                                                <div class="wsus__post_comment rev_mar" id="sticky_sidebar3">
                                                    ...
                                                    <form id="reviewFormId">
                                                        ...
                                                        <p class="rating">
                                                            ...
                                                            <i class="fas fa-star product_rat" data-rating="1"
                                                                onclick="productReview(1)"></i>
                                                            <i class="fas fa-star product_rat" data-rating="2"
                                                                onclick="productReview(2)"></i>
                                                            <i class="fas fa-star product_rat" data-rating="3"
                                                                onclick="productReview(3)"></i>
                                                            <i class="fas fa-star product_rat" data-rating="4"
                                                                onclick="productReview(4)"></i>
                                                            <i class="fas fa-star product_rat" data-rating="5"
                                                            ...
                                                            <div class="col-xl-12">
                                                                <div class="col-xl-12">
                                                                    <div class="wsus__single_com">
                                                                        <textarea name="review" cols="3" rows="3" placeholder="{{ __('user.Write your review') }}"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-xl-12">
                                                                <div class="wsus__single_com mb-3">
                                                                    <div class="g-recaptcha"
                                                                        data-sitekey="{{ $recaptchaSetting->site_key }}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        @endif
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="wsus__section_header">
                            ...
                            <a class="see_btn"
                                href="{{ route('product', ['category' => $product->category->slug]) }}">{{ __('user.see more') }}
                            ...
                            <div class="wsus__product_item wsus__after">
                                ...
                                <ul class="wsus__single_pro_icon">
                                    <li><a data-bs-toggle="modal"
                                            data-bs-target="#productModalView-{{ $relatedProduct->id }}"><i
                                                class="fal fa-eye"></i></a></li>
                                    <li><a href="javascript:;" onclick="addToWishlist('{{ $relatedProduct->id }}')"><i
                                                class="far fa-heart"></i></a></li>
                                    <li><a href="javascript:;" onclick="addToCompare('{{ $relatedProduct->id }}')"><i
                                                class="far fa-random"></i></a>
                                    </li>
                                </ul>
                                <div class="wsus__product_details">
                                    <a class="wsus__category"
                                        href="{{ route('product', ['category' => $relatedProduct->category->slug]) }}">{{ $relatedProduct->category->name }}
                                    </a>
                ...
                @foreach ($relatedProducts as $relatedProduct)
                    <section class="product_popup_modal">
                        <div class="modal fade" id="productModalView-{{ $relatedProduct->id }}" tabindex="-1"
                            aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-body">
                ...
                <form id="productModalFormId-{{ $relatedProduct->id }}">
                    <div class="wsus__quentity">
                        <h5>{{ __('user.quantity') }} :</h5>
                        <div class="modal_btn">
                            <button onclick="productModalDecrement('{{ $relatedProduct->id }}')" type="button"
                                class="btn btn-sm btn_bg">-</button>
                            <input id="productModalQty-{{ $relatedProduct->id }}" name="quantity" readonly
                ...
                <p class="brand_model"><span>{{ __('user.Brand') }} :</span> <a
                        href="{{ route('product', ['brand' => $relatedProduct->brand->slug]) }}">{{ $relatedProduct->brand->name }}</a>
                </p>
                <p class="brand_model"><span>{{ __('user.Category') }} :</span> <a
                        href="{{ route('product', ['category' => $relatedProduct->category->slug]) }}">{{ $relatedProduct->category->name }}</a>
                </p>
                <div class="wsus__pro_det_share d-none">
                    <h5>{{ __('user.share') }} :</h5>
                    <ul class="d-flex">
                        <li><a class="facebook"
                                href="https://www.facebook.com/sharer/sharer.php?u={{ route('product-detail', $relatedProduct->slug) }}&t={{ $relatedProduct->name }}"><i
                                    class="fab fa-facebook-f"></i></a></li>
                        <li><a class="twitter"
                                href="https://twitter.com/share?text={{ $relatedProduct->name }}&url={{ route('product-detail', $relatedProduct->slug) }}"><i
                                    class="fab fa-twitter"></i></a></li>
                        <li><a class="linkedin"
                                href="https://www.linkedin.com/shareArticle?mini=true&url={{ route('product-detail', $relatedProduct->slug) }}&title={{ $relatedProduct->name }}"><i
                                    class="fab fa-linkedin"></i></a></li>
                        <li><a class="pinterest"
                                href="https://www.pinterest.com/pin/create/button/?description={{ $relatedProduct->name }}&media=&url={{ route('product-detail', $relatedProduct->slug) }}"><i
                                    class="fab fa-pinterest-p"></i></a></li>
                    </ul>
                </div>
            </div>
            ...
            $(document).ready(function() {
                ...
                $("#reviewFormId").on('submit', function(e) {
                    ...
                    $.ajax({
                        ...
                        error: function(response) {
                            if (response.responseJSON.errors.rating) toastr.error(response
                                .responseJSON.errors.rating[0])
                            if (response.responseJSON.errors.review) toastr.error(response
                                .responseJSON.errors.review[0])
                            if (!response.responseJSON.errors.rating || !response
                                .responseJSON.errors.review) {
                                toastr.error(
                                    "{{ __('user.Please complete the recaptcha to submit the form') }}"
                                )
                            }
                        }
                    });
