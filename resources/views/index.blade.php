...
@section('public-content')
                                ...
                                <div class="wsus__product_item">
                                    ...
                                    <ul class="wsus__single_pro_icon">
                                        <li><a href="#" data-bs-toggle="modal"
                                                data-bs-target="#productModalView-{{ $campaignProduct->product->id }}"><i
                                                    class="far fa-eye"></i></a></li>
                                        <li><a href="javascript:;"
                                                onclick="addToWishlist('{{ $campaignProduct->product->id }}')"><i
                                                    class="far fa-heart"></i></a></li>
                                        <li><a href="javascript:;"
                                                onclick="addToCompare('{{ $campaignProduct->product->id }}')"><i
                    ...
                    <form id="productModalFormId-{{ $campaignProduct->product->id }}">
                        ...
                        <ul class="wsus__button_area">
                            ...
                            <li><a class="buy_now" href="javascript:;"
                                    onclick="addToBuyNow('{{ $campaignProduct->product->id }}')">{{ __('user.buy now') }}</a>
                            </li>
                            <li><a href="javascript:;" onclick="addToWishlist('{{ $campaignProduct->product->id }}')"><i
                                        class="fal fa-heart"></i></a></li>
                            <li><a href="javascript:;" onclick="addToCompare('{{ $campaignProduct->product->id }}')"><i
    ...
    <section id="wsus__hot_deals">
        <div class="container">
            ...
            @if ($flashDealVisibility->status == 1)
                ...
                @if ($isCampaign)
                    <h4>{{ $currencySetting->currency_icon }} <span
                            id="mainProductModalPrice-{{ $flashDealProduct->id }}">{{ sprintf('%.2f', $campaignOfferPrice + $variantPrice) }}</span>
                        <del>{{ $currencySetting->currency_icon }}{{ sprintf('%.2f', $totalPrice) }}</del>
                    </h4>
                @else
                    @if ($flashDealProduct->offer_price == null)
                ...
                <form id="productModalFormId-{{ $flashDealProduct->id }}">
                    <div class="wsus__quentity">
                        <h5>{{ __('user.quantity') }} :</h5>
                        <div class="modal_btn">
                            <button onclick="productModalDecrement('{{ $flashDealProduct->id }}')" type="button"
                                class="btn btn-danger btn-sm">-</button>
                            <input id="productModalQty-{{ $flashDealProduct->id }}" name="quantity" readonly
                                class="form-control" type="text" min="1" max="100" value="1" />
                            <button
                                onclick="productModalIncrement('{{ $flashDealProduct->id }}','{{ $flashDealProduct->qty }}')"
                                type="button" class="btn btn-success btn-sm">+</button>
                        </div>
                        <h3 class="d-none">{{ $currencySetting->currency_icon }}<span
                    ...
                    @endif
                    <ul class="wsus__button_area">
                        <li><button type="button" onclick="addToCartInProductModal('{{ $flashDealProduct->id }}')"
                                class="add_cart">{{ __('user.add to cart') }}</button></li>
                        <li><a class="buy_now" href="javascript:;"
                                onclick="addToBuyNow('{{ $flashDealProduct->id }}')">{{ __('user.buy now') }}</a></li>
                        <li><a href="javascript:;" onclick="addToWishlist('{{ $flashDealProduct->id }}')"><i
                                    class="fal fa-heart"></i></a></li>
                        <li><a href="javascript:;" onclick="addToCompare('{{ $flashDealProduct->id }}')"><i
                                    class="far fa-random"></i></a></li>
                    </ul>
                </form>
    ...
    @if ($productHighlightVisibility->status == 1)
        <div class="row">
            <div class="wsus__hot_large_item">
                        ...
                        <div class="wsus__section_header justify-content-md-center">
                            <div class="monthly_top_filter2">
                                <button class="active click_featured_product"
                                    data-filter="._featured">{{ __('user.Featured') }}</button>
                        ...
                        <div class="col-xl-3 col-sm-6 col-md-6 col-lg-4 _featured">
                            <div class="wsus__product_item">
                                ...
                                <ul class="wsus__single_pro_icon">
                                    ...
                                    <li><a href="javascript:;" onclick="addToWishlist('{{ $featuredProduct->id }}')"><i
                                                class="far fa-heart"></i></a></li>
                                    <li><a href="javascript:;" onclick="addToCompare('{{ $featuredProduct->id }}')"><i
                                                class="far fa-random"></i></a></li>
                                </ul>
                                <div class="wsus__product_details">
                                    <a class="wsus__category"
                                        href="{{ route('product', ['category' => $featuredProduct->category->slug]) }}">{{ $featuredProduct->category->name }}
                                    </a>
                                    ...
                                    @else
                                        ...
                                        @else
                                            <p class="wsus__price">
                                                {{ $currencySetting->currency_icon }}{{ sprintf('%.2f', $featuredProduct->offer_price + $variantPrice) }}
                                                <del>{{ $currencySetting->currency_icon }}{{ sprintf('%.2f', $totalPrice) }}</del>
                                            </p>
                                        @endif
                                    @endif
                                    <a class="add_cart" onclick="addToCartMainProduct('{{ $featuredProduct->id }}')"
                                        href="javascript:;">{{ __('user.add to cart') }}</a>
                                </div>
                            </div>
                        </div>
                    ...
                    @foreach ($bestProducts as $bestProduct)
                        ...
                        <div class="col-xl-3 col-sm-6 col-md-6 col-lg-4 _best">
                            <div class="wsus__product_item">
                                ...
                                <ul class="wsus__single_pro_icon">
                                    <li><a data-bs-toggle="modal"
                                            data-bs-target="#productModalView-{{ $bestProduct->id }}"><i
                                                class="fal fa-eye"></i></a></li>
                                    <li><a href="javascript:;" onclick="addToWishlist('{{ $bestProduct->id }}')"><i
                                                class="far fa-heart"></i></a></li>
                                ...
                                <div class="wsus__product_details">
                                    <a class="wsus__category"
                                        href="{{ route('product', ['category' => $bestProduct->category->slug]) }}">{{ $bestProduct->category->name }}
                                    </a>
                                    ...
                                    @else
                                        ...
                                        @else
                                            <p class="wsus__price">
                                                {{ $currencySetting->currency_icon }}{{ sprintf('%.2f', $bestProduct->offer_price + $variantPrice) }}
                                                <del>{{ $currencySetting->currency_icon }}{{ sprintf('%.2f', $totalPrice) }}</del>
                                            </p>
                                        @endif
                                    @endif
                            ...
                            <div class="wsus__product_item ">
                                ...
                                <ul class="wsus__single_pro_icon">
                                    ...
                                    <li><a href="javascript:;" onclick="addToWishlist('{{ $topProduct->id }}')"><i
                                                class="far fa-heart"></i></a></li>
                                    <li><a href="javascript:;" onclick="addToCompare('{{ $topProduct->id }}')"><i
                                                class="far fa-random"></i></a>
                                    </li>
                                </ul>
                                <div class="wsus__product_details">
                                    <a class="wsus__category"
                                        href="{{ route('product', ['category' => $topProduct->category->slug]) }}">{{ $topProduct->category->name }}
                                    </a>
                                    ...
                                    @else
                                        ...
                                        @else
                                            <p class="wsus__price">
                                                {{ $currencySetting->currency_icon }}{{ sprintf('%.2f', $topProduct->offer_price + $variantPrice) }}
                                                <del>{{ $currencySetting->currency_icon }}{{ sprintf('%.2f', $totalPrice) }}</del>
                                            </p>
                                        @endif
                                    @endif
                            ...
                            <div class="wsus__product_item wsus__after">
                                ...
                                <ul class="wsus__single_pro_icon">
                                    ...
                                    <li><a href="javascript:;" onclick="addToWishlist('{{ $newProduct->id }}')"><i
                                                class="far fa-heart"></i></a></li>
                                    <li><a href="javascript:;" onclick="addToCompare('{{ $newProduct->id }}')"><i
                                                class="far fa-random"></i></a>
                                    </li>
                                </ul>
                                <div class="wsus__product_details">
                ...
                @if ($isCampaign)
                    <h4>{{ $currencySetting->currency_icon }} <span
                            id="mainProductModalPrice-{{ $featuredProduct->id }}">{{ sprintf('%.2f', $campaignOfferPrice + $variantPrice) }}</span>
                        <del>{{ $currencySetting->currency_icon }}{{ sprintf('%.2f', $totalPrice) }}</del>
                    </h4>
                @else
                    @if ($featuredProduct->offer_price == null)
                ...
                <form id="productModalFormId-{{ $featuredProduct->id }}">
                    <div class="wsus__quentity">
                        <h5>{{ __('user.quantity') }} :</h5>
                        <div class="modal_btn">
                            <button onclick="productModalDecrement('{{ $featuredProduct->id }}')" type="button"
                                class="btn btn-danger btn-sm">-</button>
                            <input id="productModalQty-{{ $featuredProduct->id }}" name="quantity" readonly
                                class="form-control" type="text" min="1" max="100" value="1" />
                            <button
                                onclick="productModalIncrement('{{ $featuredProduct->id }}','{{ $featuredProduct->qty }}')"
                                type="button" class="btn btn-success btn-sm">+</button>
                        </div>
                        <h3 class="d-none">{{ $currencySetting->currency_icon }}<span
                    ...
                    @endif
                    <ul class="wsus__button_area">
                        <li><button type="button" onclick="addToCartInProductModal('{{ $featuredProduct->id }}')"
                                class="add_cart">{{ __('user.add to cart') }}</button></li>
                        <li><a class="buy_now" href="javascript:;"
                                onclick="addToBuyNow('{{ $featuredProduct->id }}')">{{ __('user.buy now') }}</a></li>
                        <li><a href="javascript:;" onclick="addToWishlist('{{ $featuredProduct->id }}')"><i
                                    class="fal fa-heart"></i></a></li>
                        <li><a href="javascript:;" onclick="addToCompare('{{ $featuredProduct->id }}')"><i
                                    class="far fa-random"></i></a></li>
                                ...
                                <div class="col-xl-6 col-12 col-sm-10 col-md-8 col-lg-6 m-auto display">
                                    <div class="wsus__quick_view_img">
                                        @if ($bestProduct->video_link)
                                            ...
                                            @endphp
                                            <a class="venobox wsus__pro_det_video" data-autoplay="true"
                                                data-vbtype="video" href="https://youtu.be/{{ $video_id[1] }}">
                                                <i class="fas fa-play"></i>
                                            </a>
                                        @endif
    ...
    @if ($isCampaign)
        <h4>{{ $currencySetting->currency_icon }} <span
                id="mainProductModalPrice-{{ $bestProduct->id }}">{{ sprintf('%.2f', $campaignOfferPrice + $variantPrice) }}</span>
            <del>{{ $currencySetting->currency_icon }}{{ sprintf('%.2f', $totalPrice) }}</del>
        </h4>
    @else
        @if ($bestProduct->offer_price == null)
    ...
    <form id="productModalFormId-{{ $bestProduct->id }}">
        <div class="wsus__quentity">
            <h5>{{ __('user.quantity') }} :</h5>
            <div class="modal_btn">
                <button onclick="productModalDecrement('{{ $bestProduct->id }}')" type="button"
                    class="btn btn-danger btn-sm">-</button>
                <input id="productModalQty-{{ $bestProduct->id }}" name="quantity" readonly class="form-control"
                    type="text" min="1" max="100" value="1" />
                <button onclick="productModalIncrement('{{ $bestProduct->id }}','{{ $bestProduct->qty }}')"
                    type="button" class="btn btn-success btn-sm">+</button>
            </div>
            <h3 class="d-none">{{ $currencySetting->currency_icon }}<span
                    id="productModalPrice-{{ $bestProduct->id }}">{{ sprintf('%.2f', $productPrice) }}</span></h3>
            ...
            <div class="wsus__selectbox">
                <div class="row">
                    @foreach ($productVariants as $productVariant)
                        @php
                            $items = App\Models\ProductVariantItem::orderBy('is_default', 'desc')
                                ->where(['product_variant_id' => $productVariant->id, 'product_id' => $bestProduct->id])
                                ->get();
                        @endphp
                        @if ($items->count() != 0)
                            <div class="col-xl-6 col-sm-6 mb-3">
        ...
        @endif
        <ul class="wsus__button_area">
            <li><button type="button" onclick="addToCartInProductModal('{{ $bestProduct->id }}')"
                    class="add_cart">{{ __('user.add to cart') }}</button></li>
            <li><a class="buy_now" href="javascript:;"
                    onclick="addToBuyNow('{{ $bestProduct->id }}')">{{ __('user.buy now') }}</a></li>
            <li><a href="javascript:;" onclick="addToWishlist('{{ $bestProduct->id }}')"><i
                        class="fal fa-heart"></i></a></li>
            <li><a href="javascript:;" onclick="addToCompare('{{ $bestProduct->id }}')"><i
                        class="far fa-random"></i></a></li>
    ...
    @if ($isCampaign)
        <h4>{{ $currencySetting->currency_icon }} <span
                id="mainProductModalPrice-{{ $topProduct->id }}">{{ sprintf('%.2f', $campaignOfferPrice + $variantPrice) }}</span>
            <del>{{ $currencySetting->currency_icon }}{{ sprintf('%.2f', $totalPrice) }}</del>
        </h4>
    @else
        @if ($topProduct->offer_price == null)
    ...
    <form id="productModalFormId-{{ $topProduct->id }}">
        <div class="wsus__quentity">
            <h5>{{ __('user.quantity') }} :</h5>
            <div class="modal_btn">
                <button onclick="productModalDecrement('{{ $topProduct->id }}')" type="button"
                    class="btn btn-danger btn-sm">-</button>
                <input id="productModalQty-{{ $topProduct->id }}" name="quantity" readonly class="form-control"
                    type="text" min="1" max="100" value="1" />
                <button onclick="productModalIncrement('{{ $topProduct->id }}','{{ $topProduct->qty }}')"
                    type="button" class="btn btn-success btn-sm">+</button>
            </div>
            <h3 class="d-none">{{ $currencySetting->currency_icon }}<span
                    id="productModalPrice-{{ $topProduct->id }}">{{ sprintf('%.2f', $productPrice) }}</span></h3>
            ...
            <div class="wsus__selectbox">
                <div class="row">
                    @foreach ($productVariants as $productVariant)
                        @php
                            $items = App\Models\ProductVariantItem::orderBy('is_default', 'desc')
                                ->where(['product_variant_id' => $productVariant->id, 'product_id' => $topProduct->id])
                                ->get();
                        @endphp
                        @if ($items->count() != 0)
                            <div class="col-xl-6 col-sm-6 mb-3">
        ...
        @endif
        <ul class="wsus__button_area">
            <li><button type="button" onclick="addToCartInProductModal('{{ $topProduct->id }}')"
                    class="add_cart">{{ __('user.add to cart') }}</button></li>
            <li><a class="buy_now" href="javascript:;"
                    onclick="addToBuyNow('{{ $topProduct->id }}')">{{ __('user.buy now') }}</a></li>
            <li><a href="javascript:;" onclick="addToWishlist('{{ $topProduct->id }}')"><i
                        class="fal fa-heart"></i></a></li>
            <li><a href="javascript:;" onclick="addToCompare('{{ $topProduct->id }}')"><i
                        class="far fa-random"></i></a></li>
    ...
    @if ($isCampaign)
        <h4>{{ $currencySetting->currency_icon }} <span
                id="mainProductModalPrice-{{ $newProduct->id }}">{{ sprintf('%.2f', $campaignOfferPrice + $variantPrice) }}</span>
            <del>{{ $currencySetting->currency_icon }}{{ sprintf('%.2f', $totalPrice) }}</del>
        </h4>
    @else
        @if ($newProduct->offer_price == null)
    ...
    <form id="productModalFormId-{{ $newProduct->id }}">
        <div class="wsus__quentity">
            <h5>{{ __('user.quantity') }} :</h5>
            <div class="modal_btn">
                <button onclick="productModalDecrement('{{ $newProduct->id }}')" type="button"
                    class="btn btn-danger btn-sm">-</button>
                <input id="productModalQty-{{ $newProduct->id }}" name="quantity" readonly class="form-control"
                    type="text" min="1" max="100" value="1" />
                <button onclick="productModalIncrement('{{ $newProduct->id }}','{{ $newProduct->qty }}')"
                    type="button" class="btn btn-success btn-sm">+</button>
            </div>
            <h3 class="d-none">{{ $currencySetting->currency_icon }}<span
                    id="productModalPrice-{{ $newProduct->id }}">{{ sprintf('%.2f', $productPrice) }}</span></h3>
            ...
            <div class="wsus__selectbox">
                <div class="row">
                    @foreach ($productVariants as $productVariant)
                        @php
                            $items = App\Models\ProductVariantItem::orderBy('is_default', 'desc')
                                ->where(['product_variant_id' => $productVariant->id, 'product_id' => $newProduct->id])
                                ->get();
                        @endphp
                        @if ($items->count() != 0)
                            <div class="col-xl-6 col-sm-6 mb-3">
        ...
        @endif
        <ul class="wsus__button_area">
            <li><button type="button" onclick="addToCartInProductModal('{{ $newProduct->id }}')"
                    class="add_cart">{{ __('user.add to cart') }}</button></li>
            <li><a class="buy_now" href="javascript:;"
                    onclick="addToBuyNow('{{ $newProduct->id }}')">{{ __('user.buy now') }}</a></li>
            <li><a href="javascript:;" onclick="addToWishlist('{{ $newProduct->id }}')"><i
                        class="fal fa-heart"></i></a></li>
            <li><a href="javascript:;" onclick="addToCompare('{{ $newProduct->id }}')"><i
                        class="far fa-random"></i></a></li>
                            ...
                            @foreach ($threeColumnFirstCategoryProducts as $threeColfirstCatProduct)
                                <div class="col-xl-12">
                                    <a class="wsus__hot_deals__single"
                                        ...
                                        <div class="wsus__hot_deals__single_img">
                                            <img src="{{ asset($threeColfirstCatProduct->thumb_image) }}"
                            ...
                            @foreach ($threeColumnSecondCategoryProducts as $threeColsecondCatProduct)
                                <div class="col-xl-12">
                                    <a class="wsus__hot_deals__single"
                                        ...
                                        <div class="wsus__hot_deals__single_img">
                                            <img src="{{ asset($threeColsecondCatProduct->thumb_image) }}"
                                                alt="bag" class="img-fluid w-100">
                                        </div>
                                        <div class="wsus__hot_deals__single_text">
