            ...
            <div class="dashboard_content">
                <div class="wsus__invoice_area">
                                ...
                                <div class="col-xl-4 col-md-4 mb-5 mb-md-0">
                                    <div class="wsus__invoice_single">
                                        ...
                                        <p>{{ $orderAddress->billing_address }}
                                            {{ $orderAddress->billing_city ? ', ' . $orderAddress->billing_city : '' }}
                                            {{ $orderAddress->billing_state ? ', ' . $orderAddress->billing_state : '' }}
                                            {{ $orderAddress->billing_country ? ', ' . $orderAddress->billing_country : '' }}
                                        </p>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-md-4 mb-5 mb-md-0">
                                    <div class="wsus__invoice_single text-md-center">
                                        ...
                                        <p>{{ $orderAddress->shipping_address }}
                                            {{ $orderAddress->shipping_city ? ', ' . $orderAddress->shipping_city : '' }}
                                            {{ $orderAddress->shipping_state ? ', ' . $orderAddress->shipping_state : '' }}
                                            {{ $orderAddress->shipping_country ? ', ' . $orderAddress->shipping_country : '' }}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        @foreach ($order->orderProducts as $index => $orderProduct)
                                            ...
                                            <td class="total">
                                                {{ currency_icon() }}{{ $orderProduct->unit_price * $orderProduct->qty }}
                                            </td>
                    ...
                    <div class="wsus__invoice_footer">
                        ...
                        <p><span>{{ __('user.Tax') }}(+):</span> {{ currency_icon() }}{{ $order->order_vat }}</p>
