                                    ...
                                    <tbody>
                                        <tr class="d-flex">
                                            ...
                                            @foreach ($compare_contents as $compare_content)
                                                <td class="wsus__compare_img"><img
                                                        src="{{ asset($compare_content->options->product->thumb_image) }}"
                                        ...
                                        <tr class="d-flex">
                                            ...
                                            @foreach ($compare_contents as $compare_content)
                                                <td class="wsus__compare_text">
                                                    <p><a
                                                            href="{{ route('product-detail', $compare_content->options->product->slug) }}">{{ $compare_content->options->product->short_name }}</a>
                                                    </p>
                                                </td>
                                                </td>
                                            @endforeach
                                        ...
                                        <tr class="d-flex">
                                            ...
                                            @foreach ($compare_contents as $compare_content)
                                                <td class="wsus__compare_text">
                                                    ...
                                                    @else
                                                        <span
                                                            class="wsus__compare_stock_out">{{ __('user.Out Of Stock') }}</span>
                                                    @endif
                                                ...
                                                <td class="wsus__compare_text wsus__compare_des">
                                                    @if ($product->is_specification == 1)
                                                        @foreach ($product->specifications as $specification)
                                                            <p><span>{{ $specification->key->key }} : </span> <span
                                                                    class="det">{{ $specification->specification }}</span>
                                                            </p>
                                                        @endforeach
                                                    @else
                                                        {{ __('user.N/A') }}
                                        ...
                                        <tr class="d-flex">
                                            ...
                                            @foreach ($compare_contents as $compare_content)
                                                <td class="wsus__compare_text wsus__del_area">
                                                    <a href="{{ route('remove-compare', $compare_content->rowId) }}"
                                                        class="wsus__compare_del"><i class="far fa-times"></i></a>
                                                </td>
                                            @endforeach
