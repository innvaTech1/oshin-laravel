...
class ContentController extends Controller
{
    ...
    public function maintainanceModeUpdate(Request $request)
    {
        ...
        if ($request->image) {
            ...
            $image_name = file_upload($image, $old_image, 'uploads/website-images/');
    ...
    public function updateloginPage(Request $request)
    {
        ...
        if ($request->bg_image) {
            ...
            $banner_name = file_upload($request->bg_image, $existing_banner, 'uploads/website-images/');
    ...
    public function updateDefaultAvatar(Request $request)
    {
        ...
        if ($request->avatar) {
            ...
            $default_avatar = file_upload($request->avatar, $existing_avatar, 'uploads/website-images/');
